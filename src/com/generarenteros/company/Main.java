...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double concepto;
        Cuenta cuenta1 = new Cuenta("Jose Anguiano");
        Cuenta cuenta2 = new Cuenta("Gael", 300);

        cuenta1.ingresaDineroCuenta(300);
        cuenta2.ingresaDineroCuenta(400);

        cuenta1.retirarDineroCuneta(500);
        cuenta2.retirarDineroCuneta(100);
